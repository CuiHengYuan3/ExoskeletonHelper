package com.example.utils.myview.statusbar
...
import com.example.utils.statusbar.OSUtils
import com.example.utils.statusbar.SystemBarTintManager

/**
 * 怎么用 - 在activity里面
 * override fun onCreate(savedInstanceState: Bundle?) {

Log.e("aaa","loginCreat")
...
init()
//腾出状态栏的空间
val padding = Utils.dip2px(this, 15f)
root_login.setPadding(padding, StatusBarUtil.getStatusBarHeight(this), padding, 0)
}
 *
 */
...
object StatusBarUtil {
    ...
    fun setRootViewFitsSystemWindows(activity: Activity, fitSystemWindows: Boolean) {
        ...
        Log.d("fitsSystemWindows", winContent.childCount.toString())
        if (winContent.childCount > 0) {
            val rootView = winContent.getChildAt(0) as ViewGroup
            Log.d("fitsSystemWindows", rootView.toString() + "dasdas")
            if (rootView != null) {
